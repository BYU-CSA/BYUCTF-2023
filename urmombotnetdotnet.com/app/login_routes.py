...
def post_login():
    ...
    resp = make_response(jsonify({'message': 'Successfully logged in', 'flag':('byuctf{I_used_unicode_to_make_a_username_under_4_chars_wbu?}' if len(username) < 4 else 'Nope')}), 200)
